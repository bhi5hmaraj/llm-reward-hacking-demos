...
class EquilibriumStrategy(BaseModel):
    """A single Nash equilibrium strategy profile"""

    player1_strategy: List[float] = Field(
        ...,
        description="Player 1's mixed strategy probabilities"
    )
    player2_strategy: List[float] = Field(
        ...,
        description="Player 2's mixed strategy probabilities"
    )
...
class NashEquilibrium(BaseModel):
    ...
    equilibria: List[EquilibriumStrategy] = Field(
        ...,
